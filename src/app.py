...
activities = {
    ...
    "Music Ensemble": {
        "description": "Join our band and orchestra performing classical and contemporary music",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop argumentation skills and compete in regional debate competitions",
